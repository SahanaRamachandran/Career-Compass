...
const RecruiterLens = ({ resumeText, jobDescription }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="card">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">👁️ Recruiter Lens Mode</h2>
        <p className="text-gray-600 mb-6">See what a recruiter notices in the first 30 seconds</p>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                <p className="text-sm text-gray-600 mb-2">First Impression</p>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                <p className="text-sm text-gray-600 mb-2">Visual Appeal</p>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                <p className="text-sm text-gray-600 mb-2">Decision Time</p>
                <p className="text-2xl font-bold text-gray-800">{analysis.time_to_decision}</p>
              </div>
            </div>

            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
              <h3 className="font-bold text-xl text-gray-900 mb-2">⚡ Decision</h3>
              <p className="text-lg text-gray-800 font-semibold">{analysis.likelihood}</p>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              {analysis.missing_essentials.length > 0 ? (
                ...
                <p className="text-gray-600">All essential elements present</p>
              )}
            </div>
          </div>
        )}
